...
- TypeScript: `web/packages/core/` (regex + transformers.js NER) — browser app, Chrome extension, Tauri desktop, Node CLI (`web/packages/cli`), React/Vue bindings (`web/packages/{react,vue}`)
