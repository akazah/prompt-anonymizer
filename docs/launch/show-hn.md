...
- Japanese-first: Japanese names, 〒 postal codes, and My Number with
  check-digit validation (so it doesn't blindly mask every 12-digit
  number). English, Spanish and Vietnamese too.
