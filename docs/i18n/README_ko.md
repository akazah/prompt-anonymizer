...
[docs/EVAL.md](docs/EVAL.md), 재현은 `uv run python -m prompt_anonymizer.evals`
...
1.00입니다 — TS 코어 표는 [docs/EVAL.md](docs/EVAL.md) 참고. Python NER
수치는 주간 eval에서 생성됩니다.
...
- [CONTRIBUTING.md](CONTRIBUTING.md) — 개발 환경 설정(uv / pnpm), 테스트·평가 명령
- [SECURITY.md](SECURITY.md) — 취약점 및 익명화 우회 보고
- [MIT](LICENSE)
